...
/// # Usage in SEAL:
///
/// Bootstrapping in SEAL is an advanced feature that requires careful configuration.
/// Users should refer to SEAL's official documentation or relevant publications for detailed guidelines on using bootstrapping.
///
/// # Errors
///
