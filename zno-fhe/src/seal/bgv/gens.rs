...
///
/// In the BGV encryption scheme as implemented by SEAL, the `gens` parameter specifies the
...
///
/// In SEAL's BGV encryption scheme, the parameter `gens` is a set of generators of the `p^r`-order
...
///
/// ## Range in SEAL:
/// In SEAL, the choice of `gens` depends on several factors including the security and performance requirements
/// of the specific use case. Users should refer to SEAL's official documentation or relevant publications for
