...
///
/// In the BGV encryption scheme as implemented by SEAL, the `ords` parameter specifies the
...
///
/// In SEAL's BGV encryption scheme, the parameter `ords` typically refers to the orders of the small
...
///
/// ## Range in SEAL:
/// In SEAL, the choice of `ords` contributes to the construction of the modulus chain and affects
/// the security and efficiency of cryptographic operations. A more detailed explanation and guidelines
/// can be found in SEAL's official documentation and relevant cryptographic publications.
///
/// # Example
///
/// ```
