Feature: Robust Configuration of Encryption Parameters in SEAL via Rust Interface
  To ensure secure and efficient encryption operations,
  As a developer interfacing with SEAL in a Rust environment,
  I need to accurately configure encryption parameters, focusing on the mvecs setting.

  Background:
    Given SEAL is initialized with Rust language bindings
...
# Note:
# These scenarios test the resilience and adaptability of the Rust-SEAL interface and the library's handling of various edge cases.
